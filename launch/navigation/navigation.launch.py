...
def generate_launch_description() -> LaunchDescription:
    ...
    TODO(ros2): ROS 1 loaded the costmap files into a sub-namespace of the node. ROS 2 has no per-node parameter
                namespaces, so local_costmap.yaml and global_costmap.yaml have to nest their
    ...
    local_planner_parameters = [
        ...
        ParameterFile(PathJoinSubstitution([navigation_parameters, "local_costmap.yaml"]), allow_substs=True),
    ]
    ...
    global_planner_parameters = [
        ...
        ParameterFile(PathJoinSubstitution([navigation_parameters, "global_costmap.yaml"]), allow_substs=True),
    ]
